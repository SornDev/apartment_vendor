...
<g id="g-app-brand" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
  <g id="Brand-Logo" transform="translate(-27.000000, -15.000000)">
    ...
    <span class="app-brand-text demo menu-text fw-bold ms-2">DMS</span>
  </a>
...
<ul class="menu-inner py-1">
  ...
  <li class="menu-item"  :class="$route.path=='/pre-doc'?' active':''" >
    <router-link to="/pre-doc"  class="menu-link" >
      <i class='bx bxs-file-doc menu-icon'></i>
      <div class="text-truncate text-danger" >ຮ່າງ-ແບບເອກະສານ</div>
    </router-link>
    
  </li>

  <li class="menu-item" :class="$route.path=='/tran-doc'?' active':''">
    <router-link to="/tran-doc" class="menu-link">
      <i class='bx bxs-book-content menu-icon'></i>
      <div class="text-truncate text-danger" >ລາຍການເອກະສານ</div>
    </router-link>
  </li>

  <li class="menu-item" :class="$route.path=='/rec'?' active':''">
    <router-link to="/rec" class="menu-link">
      <i class='bx bxs-receipt menu-icon'></i>
      <div class="text-truncate text-danger" >ໃບບິນ</div>
    </router-link>
  ...
  <li class="menu-item" :class="$route.path=='/acc'?' active':''">
    <router-link to="/acc" class="menu-link">
      ...
      <div class="text-truncate text-danger" >ບັນຊີ</div>
    </router-link>
    
  </li>

  <li class="menu-item" :class="$route.path=='/cus'?' active':''">
    <router-link to="/cus" class="menu-link">
      <i class='bx bxs-user-detail menu-icon'></i>
      <div class="text-truncate text-danger" >ຂໍ້ມູນລູກຄ້າ</div>
    </router-link>
...
<li class="menu-item" :class="$route.path=='/setting'?' active':''">
  ...
  <li class="menu-item" :class="$route.path=='/predoc-mg'?' active':''">
    <router-link to="/predoc-mg" class="menu-link">
      <i class='bx bxs-calendar-edit menu-icon'></i>
      <div class="text-truncate text-danger" >ຈັດການ ຮ່າງ-ແບບເອກະສານ</div>
    </router-link>
  ...
  <li class="menu-item" :class="$route.path=='/user-mg'?' active':''">
    <router-link to="/user-mg" class="menu-link">
      ...
      <div class="text-truncate text-danger" >ຈັດການ ຜູ້ໃຊ້</div>
    </router-link>
